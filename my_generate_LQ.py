# Code source: daclip-uir/scripts/generate_LQ.py
...
# sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'my_utils')))
...
def generate_LQ(deg_type='blur', param=50):
    ...
    # set data dir
    sourcedir = "../Warehouse/Diffusion-IR/datasets/train/noisy/GT"
    savedir = "../Warehouse/Diffusion-IR/datasets/train/noisy_15/LQ"
...
if __name__ == "__main__":
    generate_LQ(deg_type='noisy', param=15)