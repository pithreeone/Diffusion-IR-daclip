...
class ConditionalUNet(nn.Module):
    ...
    def __init__(self, in_nc, out_nc, nf, ch_mult=[1, 2, 4, 4], 
                    context_dim=512, use_daclip_context=True, upscale=1, in_ch_scale=2, cond_type=None, attn=True, linear_attn=True):
        super().__init__()
        ...
        for i in range(self.depth):
            ...
            self.downs.append(nn.ModuleList([
                ...
                AttentionBlock(
                        ...
                        ) if i in [3] else Residual(PreNorm(dim_in, att_down)),
            ...
            self.ups.insert(0, nn.ModuleList([
                ...
                AttentionBlock(
                            ...
                            num_head_channels=num_head_channels,
                            use_new_attention_order=False,
                        ) if i in [3] else Residual(PreNorm(dim_out, att_up)),
